...
from reliability_aware.utils.parser import get_dataset_hashes
from reliability_aware.utils.preprocessing import sha256_file
from reliability_aware.utils.shard_handling import BufferState, flush_shard
...
def extract_fasta_embeddings(
    fasta_path: str | Path,
    output_dir: str | Path,
    valid_hashes_path: str | Path = "hashlist.txt",
